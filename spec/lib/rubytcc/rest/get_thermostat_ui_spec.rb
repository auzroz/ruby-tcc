...
vcr_options = { :cassette_name => "GetThermostatUI", :record => :new_episodes, :re_record_interval => 300 }
...
describe RubyTCC::REST::GetThermostatUI, :vcr => vcr_options do
	...
	it 'should be successful' do
		expect(subject.get_thermostat_ui( { :thermostatID => THERMOSTAT_ID } ).result ).to eq "Success"
	end
	...
	describe '.get_thermostat_ui' do
		it 'should return a get thermostat ui result' do 
